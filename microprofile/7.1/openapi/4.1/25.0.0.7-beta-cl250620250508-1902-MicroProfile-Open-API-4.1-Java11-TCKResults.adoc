...
== Open Liberty 25.0.0.7-cl250620250508-1902-beta - MicroProfile Open API 4.1 Certification Summary (Java 11)
...
+
xref:25.0.0.7-beta-cl250620250508-1902-MicroProfile-Open-API-4.1-Java23-TCKResults.adoc[TCK results summary]
