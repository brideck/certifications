...
== Open Liberty 24.0.0.8 - MicroProfile Telemetry 2.0 Certification Summary (Java 11)
...
+
xref:24.0.0.8-MicroProfile-Telemetry-2.0-Java11-EE10-FEATURES-MicroProfile-70-TCKResults.adoc[TCK results summary]
...
Report generated at: 2024-07-15T14:16:53Z
Test results:
