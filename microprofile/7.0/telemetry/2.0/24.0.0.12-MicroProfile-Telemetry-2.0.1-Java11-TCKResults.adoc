...
+
https://repo1.maven.org/maven2/org/eclipse/microprofile/telemetry/microprofile-telemetry-logs-tck/2.0.1/microprofile-telemetry-logs-tck-2.0.1.jar[MicroProfile Telemetry 2.0.1 TCK]
+
